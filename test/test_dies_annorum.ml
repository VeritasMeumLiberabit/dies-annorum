let test condition message = Alcotest.(check bool) message true condition

let dates_equal message date1 date2 =
  Alcotest.(check bool)
    ( message ^ " "
    ^ CalendarLib.Printer.Date.to_string date1
    ^ " != "
    ^ CalendarLib.Printer.Date.to_string date2 )
    true (date1 = date2)
...
let date_options_equal message date1 date2 =
  ...
  in
  Alcotest.(check bool)
    (message ^ " " ^ date1_string ^ " != " ^ date2_string)
    true (date1 = date2)

let date = CalendarLib.Date.make

let first_sunday_of_advent = Dies_annorum.first_sunday_of_advent

let test_first_sunday_of_advent_dates () =
  dates_equal "First Sunday of Advent 2025:"
    (first_sunday_of_advent 2025)
    (date 2025 11 30) ;
  dates_equal "First Sunday of Advent 2026:"
    (first_sunday_of_advent 2026)
    (date 2026 11 29) ;
  dates_equal "First Sunday of Advent 2027:"
    (first_sunday_of_advent 2027)
    (date 2027 11 28) ;
  dates_equal "First Sunday of Advent 2028:"
    (first_sunday_of_advent 2028)
    (date 2028 12 3) ;
  dates_equal "First Sunday of Advent 2029:"
    (first_sunday_of_advent 2029)
    (date 2029 12 2) ;
  dates_equal "First Sunday of Advent 2030:"
    (first_sunday_of_advent 2030)
    (date 2030 12 1) ;
  dates_equal "First Sunday of Advent 2031:"
    (first_sunday_of_advent 2031)
    (date 2031 11 30) ;
  dates_equal "First Sunday of Advent 2032:"
    (first_sunday_of_advent 2032)
    (date 2032 11 28) ;
  dates_equal "First Sunday of Advent 2033:"
    (first_sunday_of_advent 2033)
    (date 2033 11 27) ;
  dates_equal "First Sunday of Advent 2034:"
    (first_sunday_of_advent 2034)
    (date 2034 12 3) ;
  dates_equal "First Sunday of Advent 2035:"
    (first_sunday_of_advent 2035)
    (date 2035 12 2) ;
  dates_equal "First Sunday of Advent 2036:"
    (first_sunday_of_advent 2036)
    (date 2036 11 30) ;
  ()

let holy_family = Dies_annorum.holy_family
...
let second_sunday_of_christmas = Dies_annorum.second_sunday_of_christmas

let test_second_sunday_of_christmas_dates () =
  (* Covers when Christmas is on all the days of the week. *)
  date_options_equal "Second Sunday of Christmas 2025:"
    (second_sunday_of_christmas 2025)
    (Some (date 2025 1 5)) ;
  date_options_equal "Second Sunday of Christmas 2026:"
    (second_sunday_of_christmas 2026)
    (Some (date 2026 1 4)) ;
  date_options_equal "Second Sunday of Christmas 2027:"
    (second_sunday_of_christmas 2027)
    (Some (date 2027 1 3)) ;
  date_options_equal "Second Sunday of Christmas 2028:"
    (second_sunday_of_christmas 2028)
    (Some (date 2028 1 2)) ;
  date_options_equal "Second Sunday of Christmas 2029:"
    (second_sunday_of_christmas 2029)
    None ;
  date_options_equal "Second Sunday of Christmas 2030:"
    (second_sunday_of_christmas 2030)
    None ;
  date_options_equal "Second Sunday of Christmas 2031:"
    (second_sunday_of_christmas 2031)
    (Some (date 2031 1 5)) ;
  date_options_equal "Second Sunday of Christmas 2032:"
    (second_sunday_of_christmas 2032)
    (Some (date 2032 1 4)) ;
  date_options_equal "Second Sunday of Christmas 2033:"
    (second_sunday_of_christmas 2033)
    (Some (date 2033 1 2)) ;
  date_options_equal "Second Sunday of Christmas 2034:"
    (second_sunday_of_christmas 2034)
    None ;
  date_options_equal "Second Sunday of Christmas 2035:"
    (second_sunday_of_christmas 2035)
    None ;
  date_options_equal "Second Sunday of Christmas 2036:"
    (second_sunday_of_christmas 2036)
    None ;
  date_options_equal "Second Sunday of Christmas 2037:"
    (second_sunday_of_christmas 2037)
    (Some (date 2037 1 4)) ;
  date_options_equal "Second Sunday of Christmas 2038:"
    (second_sunday_of_christmas 2038)
    (Some (date 2038 1 3)) ;
  date_options_equal "Second Sunday of Christmas 2039:"
    (second_sunday_of_christmas 2039)
    (Some (date 2039 1 2)) ;
  date_options_equal "Second Sunday of Christmas 2040:"
    (second_sunday_of_christmas 2040)
    None ;
  ()

let epiphany_sunday = Dies_annorum.epiphany_sunday
...
let baptism = Dies_annorum.baptism_of_our_lord
...
let baptism_displaced = Dies_annorum.baptism_of_our_lord_transferred
...
let easter = Dies_annorum.easter
...
let _ =
  Alcotest.run "Test Suite"
    [ ( "Dates",
        [ Alcotest.test_case "First Sunday of Advent date for years" `Quick
            test_first_sunday_of_advent_dates;
          Alcotest.test_case "Holy Family date for years" `Quick
            test_holy_family_dates;
          Alcotest.test_case "Second Sunday of Christmas date for years" `Quick
            test_second_sunday_of_christmas_dates;
          Alcotest.test_case "Epiphany Sunday date for years" `Quick
            test_epiphany_sunday;
          Alcotest.test_case "Baptism of the Lord date for years" `Quick
            test_baptism;
          Alcotest.test_case "Baptism of the Lord displaced date for years" `Quick
            test_baptism_displaced;
